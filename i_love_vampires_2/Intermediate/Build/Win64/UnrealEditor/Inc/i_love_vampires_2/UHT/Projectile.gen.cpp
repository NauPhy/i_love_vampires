...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AProjectile_Statics::NewProp__projectileConfig = { "_projectileConfig", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AProjectile, _projectileConfig), Z_Construct_UClass_UProjectileConfig_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp__projectileConfig_MetaData), NewProp__projectileConfig_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AProjectile_Statics::NewProp__projectileAttributes = { "_projectileAttributes", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AProjectile, _projectileAttributes), Z_Construct_UClass_UProjectileAttributes_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp__projectileAttributes_MetaData), NewProp__projectileAttributes_MetaData) };
...
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UProjectileConfig_Statics::NewProp__attackShape = { "_attackShape", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UProjectileConfig, _attackShape), Z_Construct_UEnum_i_love_vampires_2_EAttackShape, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp__attackShape_MetaData), NewProp__attackShape_MetaData) }; // 2235169003
...
AProjectileFactory::AProjectileFactory(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {}
...
struct Z_CompiledInDeferFile_FID_Users_Byron_Documents_GitHub_i_love_vampires_i_love_vampires_2_Source_i_love_vampires_2_Projectile_h__Script_i_love_vampires_2_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AProjectile, AProjectile::StaticClass, TEXT("AProjectile"), &Z_Registration_Info_UClass_AProjectile, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AProjectile), 674965411U) },
		{ Z_Construct_UClass_UProjectileConfig, UProjectileConfig::StaticClass, TEXT("UProjectileConfig"), &Z_Registration_Info_UClass_UProjectileConfig, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UProjectileConfig), 1170719196U) },
		{ Z_Construct_UClass_UProjectileAttributes, UProjectileAttributes::StaticClass, TEXT("UProjectileAttributes"), &Z_Registration_Info_UClass_UProjectileAttributes, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UProjectileAttributes), 1334101775U) },
		{ Z_Construct_UClass_UProjectileComponent, UProjectileComponent::StaticClass, TEXT("UProjectileComponent"), &Z_Registration_Info_UClass_UProjectileComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UProjectileComponent), 746303880U) },
		{ Z_Construct_UClass_AProjectileFactory, AProjectileFactory::StaticClass, TEXT("AProjectileFactory"), &Z_Registration_Info_UClass_AProjectileFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AProjectileFactory), 2364308921U) },
		{ Z_Construct_UClass_UProjectileFactoryTemplate, UProjectileFactoryTemplate::StaticClass, TEXT("UProjectileFactoryTemplate"), &Z_Registration_Info_UClass_UProjectileFactoryTemplate, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UProjectileFactoryTemplate), 3582007412U) },
	};
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Byron_Documents_GitHub_i_love_vampires_i_love_vampires_2_Source_i_love_vampires_2_Projectile_h__Script_i_love_vampires_2_2650391726{
