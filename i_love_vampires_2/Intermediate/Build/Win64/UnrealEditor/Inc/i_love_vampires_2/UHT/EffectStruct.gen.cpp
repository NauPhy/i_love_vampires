...
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FEffectStruct_Statics::NewProp__type = { "_type", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FEffectStruct, _type), Z_Construct_UEnum_i_love_vampires_2_EStatus, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp__type_MetaData), NewProp__type_MetaData) }; // 1367986899
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FEffectStruct_Statics::NewProp__magnitude = { "_magnitude", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FEffectStruct, _magnitude), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp__magnitude_MetaData), NewProp__magnitude_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FEffectStruct_Statics::NewProp__duration = { "_duration", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FEffectStruct, _duration), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp__duration_MetaData), NewProp__duration_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FEffectStruct_Statics::NewProp__chance = { "_chance", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FEffectStruct, _chance), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp__chance_MetaData), NewProp__chance_MetaData) };
...
struct Z_CompiledInDeferFile_FID_Users_Byron_Documents_GitHub_i_love_vampires_i_love_vampires_2_Source_i_love_vampires_2_EffectStruct_h__Script_i_love_vampires_2_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FEffectStruct::StaticStruct, Z_Construct_UScriptStruct_FEffectStruct_Statics::NewStructOps, TEXT("EffectStruct"),&Z_Registration_Info_UScriptStruct_FEffectStruct, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FEffectStruct), 4244353823U) },
	};
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Byron_Documents_GitHub_i_love_vampires_i_love_vampires_2_Source_i_love_vampires_2_EffectStruct_h__Script_i_love_vampires_2_2982889586{
