...
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FEffectStruct_Statics::NewProp__type = { "_type", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FEffectStruct, _type), Z_Construct_UEnum_i_love_vampires_2_EStatus, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp__type_MetaData), NewProp__type_MetaData) }; // 1901352319
...
struct Z_CompiledInDeferFile_FID_Users_Byron_Documents_GitHub_i_love_vampires_i_love_vampires_2_Source_i_love_vampires_2_EffectStruct_h__Script_i_love_vampires_2_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FEffectStruct::StaticStruct, Z_Construct_UScriptStruct_FEffectStruct_Statics::NewStructOps, TEXT("EffectStruct"),&Z_Registration_Info_UScriptStruct_FEffectStruct, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FEffectStruct), 3835830319U) },
	};
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Byron_Documents_GitHub_i_love_vampires_i_love_vampires_2_Source_i_love_vampires_2_EffectStruct_h__Script_i_love_vampires_2_2110021540{
