...
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UAutomaticAssetRefs_getRandomWeapon_Statics::NewProp_ignored = { "ignored", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AutomaticAssetRefs_eventgetRandomWeapon_Parms, ignored), EArrayPropertyFlags::None, METADATA_PARAMS(0, nullptr) };
...
RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UAutomaticAssetRefs_getRandomWeapon_Statics::Function_MetaDataParams), Z_Construct_UFunction_UAutomaticAssetRefs_getRandomWeapon_Statics::Function_MetaDataParams)},  };
...
{
	P_GET_TARRAY(UWeaponTemplate*,Z_Param_ignored);
	P_FINISH;
	P_NATIVE_BEGIN;
	*(const UWeaponTemplate**)Z_Param__Result=P_THIS->getRandomWeapon(Z_Param_ignored);
	P_NATIVE_END;
}
...
// ********** End Class UAutomaticAssetRefs constinit property declarations ************************
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UAutomaticAssetRefs_getRandomWeapon, "getRandomWeapon" }, // 3592314908
	};
...
struct Z_CompiledInDeferFile_FID_Users_Byron_Documents_GitHub_i_love_vampires_i_love_vampires_2_Source_i_love_vampires_2_AutomaticAssetRefs_h__Script_i_love_vampires_2_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UAutomaticAssetRefs, UAutomaticAssetRefs::StaticClass, TEXT("UAutomaticAssetRefs"), &Z_Registration_Info_UClass_UAutomaticAssetRefs, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAutomaticAssetRefs), 1583937645U) },
	};
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Byron_Documents_GitHub_i_love_vampires_i_love_vampires_2_Source_i_love_vampires_2_AutomaticAssetRefs_h__Script_i_love_vampires_2_3091684599{
