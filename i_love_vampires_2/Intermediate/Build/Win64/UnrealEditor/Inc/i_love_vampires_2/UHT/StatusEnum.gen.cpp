...
struct Z_Construct_UEnum_i_love_vampires_2_EStatusEffect_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		...
		{ "burn.Name", "EStatusEffect::burn" },
		{ "max.Hidden", "" },
		{ "max.Name", "EStatusEffect::max" },
		{ "ModuleRelativePath", "StatusEnum.h" },
	};
#endif // WITH_METADATA
	static constexpr UECodeGen_Private::FEnumeratorParam Enumerators[] = {
		{ "EStatusEffect::bleed", (int64)EStatusEffect::bleed },
		{ "EStatusEffect::burn", (int64)EStatusEffect::burn },
		{ "EStatusEffect::max", (int64)EStatusEffect::max },
	};
...
struct Z_CompiledInDeferFile_FID_Users_Byron_Documents_GitHub_i_love_vampires_i_love_vampires_2_Source_i_love_vampires_2_StatusEnum_h__Script_i_love_vampires_2_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ EStatusEffect_StaticEnum, TEXT("EStatusEffect"), &Z_Registration_Info_UEnum_EStatusEffect, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1052355698U) },
	};
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Byron_Documents_GitHub_i_love_vampires_i_love_vampires_2_Source_i_love_vampires_2_StatusEnum_h__Script_i_love_vampires_2_3408490516{
