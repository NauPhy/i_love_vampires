...
// IWYU pragma: private, include "DamageNumber.h"

#ifdef I_LOVE_VAMPIRES_2_DamageNumber_generated_h
#error "DamageNumber.generated.h already included, missing '#pragma once' in DamageNumber.h"
#endif
#define I_LOVE_VAMPIRES_2_DamageNumber_generated_h
...
private: \
	...
	friend I_LOVE_VAMPIRES_2_API UClass* ::Z_Construct_UClass_UDamageNumber_NoRegister(); \
public: \
	DECLARE_CLASS2(UDamageNumber, UUserWidget, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/i_love_vampires_2"), Z_Construct_UClass_UDamageNumber_NoRegister) \
...
#define FID_Users_Byron_Documents_GitHub_i_love_vampires_i_love_vampires_2_Source_i_love_vampires_2_DamageNumber_h_10_ENHANCED_CONSTRUCTORS \
	...
	UDamageNumber(UDamageNumber&&) = delete; \
	UDamageNumber(const UDamageNumber&) = delete; \
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, UDamageNumber); \
	DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(UDamageNumber); \
	DEFINE_DEFAULT_OBJECT_INITIALIZER_CONSTRUCTOR_CALL(UDamageNumber) \
