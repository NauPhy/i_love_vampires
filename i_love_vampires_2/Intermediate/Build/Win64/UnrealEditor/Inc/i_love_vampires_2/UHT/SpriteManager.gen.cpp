...
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_USpriteManager_Statics::NewProp__sprites_Key_KeyProp = { "_sprites_Key", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UEnum_i_love_vampires_2_ESprite, METADATA_PARAMS(0, nullptr) }; // 1816186303
const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_USpriteManager_Statics::NewProp__sprites = { "_sprites", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USpriteManager, _sprites), EMapPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp__sprites_MetaData), NewProp__sprites_MetaData) }; // 1816186303
...
struct Z_CompiledInDeferFile_FID_Users_Byron_Documents_GitHub_i_love_vampires_i_love_vampires_2_Source_i_love_vampires_2_SpriteManager_h__Script_i_love_vampires_2_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_USpriteManager, USpriteManager::StaticClass, TEXT("USpriteManager"), &Z_Registration_Info_UClass_USpriteManager, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USpriteManager), 3676279905U) },
	};
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Byron_Documents_GitHub_i_love_vampires_i_love_vampires_2_Source_i_love_vampires_2_SpriteManager_h__Script_i_love_vampires_2_435853848{
